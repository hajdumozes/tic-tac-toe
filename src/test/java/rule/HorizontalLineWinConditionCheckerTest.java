...
class HorizontalLineWinConditionCheckerTest {

    HorizontalLineWinConditionChecker horizontalLineWinConditionChecker;

    @BeforeEach
    public void init() {
        horizontalLineWinConditionChecker = new HorizontalLineWinConditionChecker();
    }
    ...
    public void givenThereAreNoThreeExactSignNextToEachOther_checkWinner_shouldReturnWithNoWinner() {
        ...
        // When
        Optional<Character> actual = horizontalLineWinConditionChecker.checkWinner(board);
        // Then
    ...
    public void givenThereAreThreeExactSignNextToEachOther_checkWinner_shouldReturnWinnerPlayerSign() {
        ...
        board.editCell(new Cell(1,2), playerSign);
        // When
        Optional<Character> actual = horizontalLineWinConditionChecker.checkWinner(board);
        // Then
